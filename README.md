...
![Tela de Login](FRONT/login.png)
<br>

### 👩‍💼 Menu do Funcionário / Employee Menu
![Menu do Funcionário](FRONT/menu_funcionario.png)
<br>

### 👨‍💼 Menu do Gestor / Manager Menu
![Menu do Gestor](FRONT/menu_gestor.png)
<br>

### 🧑‍⚕️ Menu do Médico / Doctor Menu
![Menu do Médico](FRONT/menu_medico.png)
<br>

### 🧑‍⚕️ Periódico / Periodical
![Periódico](FRONT/periodico.png)
<br>

### 📝 Cadastro de Funcionário / Employee Registration
![Cadastro de Funcionário](FRONT/cadastro.png)
<br>

### ✏️ Atualização de Funcionário / Employee Update
![Atualização de Funcionário](FRONT/atualizacao.png)
<br>

### ⏱️ Registro de Ponto / Time Record
![Registro de Ponto](FRONT/ponto.png)
<br>

### ⏱️ Consulta de Ponto / Point Query
![Consulta de Ponto](FRONT/consulta.png)
<br>

### ⏱️ Lista de Funcionários / List of Employees
![Lista de Funcionários](FRONT/listar_funcionarios.png)
<br>

### 📄 Envio de Atestado / Medical Certificate Upload
![Envio de Atestado](FRONT/atestados.png)
<br>
    ---
